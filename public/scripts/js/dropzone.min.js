    ...
    return function() {
        ...
        return function() {
            ...
            var s = {
                ...
                autoQueue: !0,
                addRemoveLinks: !0,
                previewsContainer: "#custom-dropzone",
                disablePreviews: !1,
                ...
                renameFile: null,
                forceFallback: !1,
                dictDefaultMessage: "Cliquer pour choisir un fichier CSV ou glisser-déposer",
                ...
                removedfile: function(e) {
                    return null != e.previewElement && null != e.previewElement.parentNode && e.previewElement.parentNode.removeChild(e.previewElement) && submitButton.classList.add("disabled", "d-none"), this._updateMaxFilesReachedClass()
                },
                ...
                success: function(e) {
                    if (e.previewElement) return e.previewElement.classList.add("dz-success"), document.querySelector(".results").classList.remove('d-none'), button.innerHTML = "&#10003;";
                },
